...
: <<'IRANUX_METADATA'
{
  ...
  "script": {
    ...
    "version": "1.0.0",
    "description": "Adds or reuses a Cloudflare full zone using Global API Key authentication, prints Cloudflare-assigned nameservers, creates or updates A records for root and ns with proxy disabled, and creates or updates fixed NS records for v, vs, s, ss, t, and ts. https"//youtube.com/@iranux"
  },
  "risk": {
    "level": "high"
  },
